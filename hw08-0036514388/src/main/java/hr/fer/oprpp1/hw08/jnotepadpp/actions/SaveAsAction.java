...
/**
 * Razred predstavlja akciju pohrane dokumenta iz JNotepadPP na disk.
 * 
 * @author borna
 *
 */
public class SaveAsAction extends LocalizableAction {
	 ...
	 */
	public SaveAsAction(DefaultMultipleDocumentModel model, String s, ILocalizationProvider provider) {
		super(s, provider);
		this.model = model;
		this.setEnabled(false);
		
		this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke("control alt S")); 
		this.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_S); 
		this.putValue(Action.SHORT_DESCRIPTION, "Used to save file to disk."); 
	}
