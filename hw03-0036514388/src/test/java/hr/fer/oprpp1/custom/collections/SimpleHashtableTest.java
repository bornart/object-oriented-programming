...
public class SimpleHashtableTest {
    ...
    public void testClear2() {
        ...
        assertEquals(null, testTable.get("Ante"));
    ...
    public void testToString() {
        ...
        assertEquals("[Josip=100, Ante=2, Ivana=5, Jasna=2, Kristina=2]", testTable.toString());
    ...
    public void testHashtableDoubleIterator() {
        ...
        assertEquals("Ante => 2Ivana => 5Jasna => 2Kristina => 5",sb.toString());
