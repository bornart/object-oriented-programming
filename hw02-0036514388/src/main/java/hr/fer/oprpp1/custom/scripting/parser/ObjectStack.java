...
public class ObjectStack {
	...
	private ArrayIndexedCollection arrCollection;
	 ...
	 */
	public ObjectStack(ArrayIndexedCollection arrCollection) {
	 ...
	 */
	public ObjectStack() {
		this.arrCollection = new ArrayIndexedCollection();
	}
	...
	public Object pop() {
		...
		try {
			...
			throw new SmartScriptParserException("Stog je prazan! Nemoguce je obaviti operaciju skidanja vrijednosti sa stoga.");
		}
