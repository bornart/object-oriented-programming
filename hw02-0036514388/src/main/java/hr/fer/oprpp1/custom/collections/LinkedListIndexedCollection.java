...
public class LinkedListIndexedCollection implements List {
	 ...
	 *
	 */
	private static class InnerGetter implements ElementsGetter {
		
		private LinkedListIndexedCollection outerColl;
		 ...
		 */
		public InnerGetter(LinkedListIndexedCollection coll) {
			outerColl = coll;
		...
		public Object getNextElement() {
			...
			Object nextElement = currentNode.valueStorage;
